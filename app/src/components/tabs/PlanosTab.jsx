...
export default function PlanosTab() {
  return (
    <section className="page-section" style={{ padding: '64px 48px 90px', maxWidth: 1000, margin: '0 auto' }}>
      <h2 className="section-title" style={{ fontSize: 34, fontWeight: 800, margin: '0 0 8px', textAlign: 'center' }}>Planos</h2>
