...
export default function RecompensasTab() {
  ...
  return (
    <section className="page-section" style={{ padding: '64px 48px 90px', maxWidth: 1120, margin: '0 auto' }}>
      <h2 className="section-title" style={{ fontSize: 34, fontWeight: 800, margin: '0 0 8px' }}>Recompensas</h2>
      ...
      <div className="leaderboard-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.15fr 1fr', gap: 16, alignItems: 'end', marginBottom: 48 }}>
      ...
      <div className="rewards-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 32, marginBottom: 48, alignItems: 'center' }}>
        ...
        <div>
          ...
          <div className="badges-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14, marginBottom: 14 }}>
